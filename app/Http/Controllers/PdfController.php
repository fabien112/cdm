...

{
...

    {
        ...
        $moys = MoyenneTrimestres::with('student')->where('classe_id', $IdClasse)->where('trimestre_id', $IdTrimmestre)->where('session', $session)
            ->where('codeEtab', $codeEtab)->where('valeur', '>', 0.5)->orderBy('valeur', 'DESC')->get();
...

    {
        ...
        foreach ($moyData as $moy) {
            ...
            $this->fpdf->SetXY(10, 73);


            $this->fpdf->SetFont('Arial', 'B', 30);

            $this->fpdf->Cell(277, 17, "TABLEAU D'HONNEUR" . ' ', 0, 0, 'C', 1);
...

    {
        ...
        foreach ($moyData as $moy) {
            ...
            $this->fpdf->Cell(277, 17,  $mention . ' ', 0, 0, 'C', 1);
...

    {
        ...
        $this->fpdf->SetFillColor('10', '75', '168');
        $this->fpdf->SetTextColor('0', '0', '0');
        $this->fpdf->Cell(10, 10, 'Num', 1, 0, 'C', 1);
        $this->fpdf->Cell(20, 10, 'Matricule', 1, 0, 'C', 1);
...

    {
        ...
        foreach ($moyData   as $key => $data) {
            ...
            $this->fpdf->Image(public_path("/Photos/Logos/" . $entete), 5, 8, 205, 32, "");
            ...
            $this->fpdf->Text(105, 75, 'Situatuion : ');
            $this->fpdf->SetFont('Arial', 'B', 7);
            $this->fpdf->Text(137, 75, $data->student->doublant);
            $this->fpdf->SetFont('Arial', 'B', $tailleLIbelleMatiere);
            ...
            $this->fpdf->Cell(20, 7, utf8_decode('Appréciation'), 1, 0, 'C', 1);
            $this->fpdf->Cell(63, 7, 'Enseignant (e)', 1, 0, 'C', 1);
            ...
            foreach ($Note[$data->student->id] as $note) {
                ...
                $this->fpdf->SetX(120);
                $this->fpdf->MultiCell(20, 8, utf8_decode($note->mention), 1, 'C');
            }
            ...
            foreach ($Note[$data->student->id] as $note) {
                ...
                $this->fpdf->SetX(110);
                $this->fpdf->SetFont('Arial', 'B',  7);
                $this->fpdf->MultiCell(10, 8, $rank + 1 . 'e', 1, 'C');
            }
            ...
            foreach ($Note[$data->student->id] as $note) {
                ...
                $this->fpdf->SetX(140);
                $this->fpdf->MultiCell(63, 8, utf8_decode($note->user->nom) . ' ' . utf8_decode($note->user->prenom) . ' ', 1, 'L');
            }
            ...
            foreach ($Note2[$data->student->id] as $note2) {
                ...
                $this->fpdf->SetX(120);
                $this->fpdf->MultiCell(20, 8, utf8_decode($note2->mention), 1, 'C');
            }
            ...
            foreach ($Note2[$data->student->id] as $note2) {
                ...
                $this->fpdf->SetFont('Arial', 'B', $tailleLIbelleMatiere);
                $this->fpdf->SetX(140);
                $this->fpdf->MultiCell(63, 8, utf8_decode($note2->user->nom) . ' ' . utf8_decode($note2->user->prenom) . ' ', 1, 'L');
            }
            ...
            foreach ($Note3[$data->student->id] as $note3) {
                ...
                $this->fpdf->SetFont('Arial', 'B', 7);
                $this->fpdf->SetX(120);
                $this->fpdf->MultiCell(20, 8, utf8_decode($note3->mention), 1, 'C');
            }
            ...
            foreach ($Note3[$data->student->id] as $note3) {
                ...
                $this->fpdf->SetFont('Arial', 'B', $tailleLIbelleMatiere);
                $this->fpdf->SetX(140);
                $this->fpdf->MultiCell(63, 8, utf8_decode($note3->user->nom . ' ' . $note3->user->prenom) . ' ', 1, 'L');
            }
            ...
            $this->fpdf->SetX(10);
            $this->fpdf->SetFont('Arial', 'B', 6);
            $this->fpdf->Cell(70, 6, utf8_decode('Enseignement Complémenataire'), 1, 0, 'C', 1);
            ...
            $this->fpdf->Cell(50, 30, '', 1, 0, 'L', 0);
            $this->fpdf->Cell(93, 30, utf8_decode(''), 1, 0, 'L', 0);
            $this->fpdf->Cell(50, 30, '      Douala le ...........', 1, 0, 'L', 0);
...

    {
        ...
        $moyData =   MoyenneTrimestres::with('student')->where('session', $session)
            ->where('codeEtab', $codeEtab)->where('trimestre_id',  $IdTrimmestre)->where('classe_id', $IdClasse)->where('valeur', '>=', 0.5)
            ->orderBy('valeur', 'DESC')->get();
        ...
        $MoyDernier = MoyenneTrimestres::where('trimestre_id',  $IdTrimmestre)->where('valeur', '>=', 1)->where('classe_id', $IdClasse)->min('valeur');


        // // Moyenne du premier

        $MoyPremier = MoyenneTrimestres::where('trimestre_id', $IdTrimmestre)->where('valeur', '>=', 0.5)->where('classe_id', $IdClasse)->max('valeur');
        ...
        foreach ($moyData   as $ley => $data) {
            ...
            $this->fpdf->AddPage("P", ['325', '210']); // 315
            ...
            $this->fpdf->SetFont('Arial', 'B', 12);
            $this->fpdf->SetXY(10, 45);
            $this->fpdf->Cell(0, 0, 'BULLETIN DE NOTES ' . '' . strtoupper($libelleTrimestre), 0, 0, 'C');
            ...
            foreach ($NoteTrimestre[$data->student->id] as $note) {
                ...
                $this->fpdf->SetX(120);
                $this->fpdf->MultiCell(10, 7, $rank + 1 . 'e', 1, 'C');
            }
            ...
            $this->fpdf->SetFont('Arial', 'B', 6);
            $this->fpdf->Cell(60, 6, utf8_decode('Enseignement Complémenataire '), 1, 0, 'C', 1);
            ...
            $this->fpdf->Ln(5);
            $this->fpdf->SetX(10);
            $this->fpdf->Cell(50, 25, utf8_decode(''), 1, 0, 'L', 0);
            $this->fpdf->Cell(93, 25, utf8_decode(''), 1, 0, 'L', 0);
            $this->fpdf->Cell(50, 25, '      Douala le ..........................................', 1, 0, 'L', 0);
