...

{
     ...
     */
     ...
     public function createEmpldoiTempsDash(Request $request){
        ...
        foreach ($cours as $cour) {
            ...
            if(tabletimes::where('id_jour', $idJour)->where('id_heureD',$cour['heureD']['libelle'])
                    ->where('id_heureF',$cour['heureF']['libelle'])->exists()) {
                        ...
                        if(isset($cour['Idteacher'])){

                            $cour['Idteacher'] = $cour['Idteacher'] ;
                        }
                        ...
                        tabletimes::Create([
                            ...
                            'enseignant_id'=>$cour['Idteacher'],
                            'classe_id' => $idClasse,
                            'id_heureD' =>$cour['heureD']['libelle'],
                            'id_heureF' =>$cour['heureF']['libelle'],
                            'id_jour' =>   $idJour
...

    {
        ...
        $Datas = libelleMatieres::where('session', $sessioEncour)->where('codeEtab', $codeEtab)->orderBy('id', 'DESC')->get();
...

    {
        ...
        $Datas = Matieres::where('session', $sessioEncour)->where('codeEtab', $codeEtab)->where('classe_id', $idClasse)->orderBy('id', 'DESC')->get();
