...

{
...

        {
           ...
           $trimestreId = $value->trimestre_id ;
            ...
            foreach ($eleves  as $eleve) {
                ...
                if (Presences::where('evaluation_id', $request->libelleEvaluation)->where('student_id', $IdEleve)
    ...
    public function getStudentBySg2(Request $request) {
            ...
            foreach ($Eleves as  $Ideleve) {
                ...
                $abs = Presences::where('student_id', $Ideleve->id)->where('evaluation_id', $request->libelleEvaluation)->where('duree', '>',0)->sum('duree');
