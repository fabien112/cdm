                    ...
                    <section class="content">
                        <div class="box box-default">
                            ...
                            <div class="box-header" style="background-color:#0052CC;text-align: center; color:white">
                                ...
                                <h4 class="box-title">
                                    Les absences non justifiées  par devoir ou séquence
                                </h4>
                            </div>
                                                                ...
                                                                <tbody name="fruit-table" is="transition-group">
                                                                    ...
                                                                    i) in Classes" :key="i">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <button class="btn btn-danger">  {{data.heure}} </button>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <router-link to="recapAbsenceSg">
                                                                                ...
                                                                                <button class="btn btn-primary"> <Icon type="md-create" /> Plus  </button>
