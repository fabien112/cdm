                                ...
                                <div class="box no-shadow mb-0 bg-transparent">
                                    <div class="box-header no-border px-0">
                                        <Alert fade=true show-icon closable>
                                            ...
                                            <template slot="desc">
                                                Total : {{ ElevesAbsences.sommmeTrimetre }} h  ,  Non justifié :  {{ ElevesAbsences.sommeTrimestreNonJust }} h
                                            </template>
                                ...
                                <div class="box no-shadow mb-0 bg-transparent">
                                    <div class="box-header no-border px-0">
                                        <Alert type="error" fade=true show-icon closable>
                                            ...
                                            Absences de l'année
                                            <template slot="desc">
                                                Total :  {{ ElevesAbsences.sommeAnnee }} h ,  Non justifié :  {{ ElevesAbsences.sommeAnneeNjust }} h
                                            </template>
                                        </Alert>
                                    </div>
                                </div>
                                            ...
                                            <table id="example" class="table simple mb-0" style="width:100%">
                                                ...
                                                <tbody name="fruit-table" is="transition-group">
                                                    ...
                                                    i) in ElevesAbsences.listeTrimestre" :key="i">
                                                        <td>
                                                            {{
                                                                    data.dateHeure|dateFormatHeure
                                                            }}
                                                        </td>

                                                        <td>

                                                           Devoir {{data.evaluation_id}}
                                                        ...
                                                        <td>
                                                            <span  v-if="data.etat==0" style="color:#f60" >  Non Jusifié </span>
...
export default {
    ...
    methods: {
        ...
        async Update () {
            ...
            this.data.id = this.delateItem
            const response = await axios.post(
                "api/locale/updateAbsence",
                this.data
            );

            if (response.status === 200) {
                this.EdetingModal = false;
                this.s("Absence modifiée correctement");
