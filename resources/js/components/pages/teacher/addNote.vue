                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select v-model="datas.trimestre"
                                                            class="custom-select form-control required">
                                                            <option selected="selected" :value="Trimestre.id">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <Alert type="info" show-icon closable>
                                                    ...
                                                    <p style="text-align:center"> Ajoutez une note pour chaque élève
                                                    </p>
