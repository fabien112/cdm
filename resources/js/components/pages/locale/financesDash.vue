                                    ...
                                    <div class="box-header no-border px-0">
                                        <Alert  fade=true show-icon closable>
                                            ...
                                            <template slot="desc">
                                                ...
                                                {{ parseInt(financeClasse.tranche2) + parseInt(financeClasse.tranche1) + parseInt(financeClasse.ape)}}
                                            </template>
                                        </Alert>
                                    </div>
                                </div>
                                ...
                                <div class="box no-shadow mb-0 bg-transparent">
                                    <div class="box-header no-border px-0">
                                        <Alert type="error" fade=true show-icon closable>
                                           ...
                                           Total reste globale
                                            <template slot="desc">
                                                {{financeClasse2.tranche1+financeClasse2.tranche2+financeClasse2.ape-financeClasse.ape-financeClasse.tranche1-financeClasse.tranche2}}
                                            </template>
                                        </Alert>
                                    </div>
                                </div>
                                            ...
                                            <table id="example" class="table simple mb-0" style="width:100%">
                                                ...
                                                <tbody v-if="showRecap == true" name="fruit-table"
                                                    ...
                                                    i) in EleveListes" :key="i">
                                                        ...
                                                        <!-- <td>
                                                            <router-link to="detailsEleveFinance2">
                                                                <span @click="
                                                                    details(
                                                                        data,
                                                                        i
                                                                ...
                                                                " class="btn"
                                                                    style="color:white;background-color: #0052CC;;"
                                                                    title="Tous les paiements détailllés ">
                                                                    <Icon type="md-more" />
                                                                </span>
                                                            </router-link>
                                                        </td> -->
