                            ...
                            <div class="box-body wizard-content">
                                <form action="#" class="" @submit.prevent="onSubmit">
                                    ...
                                    <section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <button icon="ios-search" class="btn btn-danger " @click="modal7 = true"
                                                    size="large">
                                                   <Icon type="md-git-compare" /> Changer son  parent
                                                </button>
                                            </div>
                                            <!-- <div class="col-md-6">
                                                <Button
                                        ...
                                        <div class="row">
                                            <Divider>
                                                INFORMATION SUR LE PARENT PARENT
                                            </Divider>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>
