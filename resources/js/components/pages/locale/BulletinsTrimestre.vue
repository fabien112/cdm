    ...
    methods: {
        ...
        async update() {
            ...
            if (response7.status != 200) {
                ...
                this.e("Toutes les notes des deux séquences de ce trimestre dans cette classe n'ont pas été saisies");
        ...
        async afficher() {
            ...
            window.open('api/locale/getAllBulletinExamTrimestre/' + this.datas.classeName + '*' + this.datas.libelleEvaluation, '_blank')

            const response2 = await this.callApi(
                "get",
                "api/locale/getAllBulletinExamTrimestre/" + this.datas.classeName + '*' + this.datas.libelleEvaluation
        ...
        async afficher2() {
            ...
            window.open('api/locale/getAllProcesVerbalTrimestre/' + this.datas.classeName + '*' + this.datas.libelleEvaluation, '_blank')

            const response2 = await this.callApi(
                "get",
                "api/locale/getAllProcesVerbalTrimestre/" + this.datas.classeName + '*' + this.datas.libelleEvaluation
...
window.open('api/locale/getAllProcesVerbalTrimestre2/' + this.datas.classeName + '*' + this.datas.libelleEvaluation, '_blank')

const response2 = await this.callApi(
    "get",
    "api/locale/getAllProcesVerbalTrimestre2/" + this.datas.classeName + '*' + this.datas.libelleEvaluation
