                    ...
                    <section class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-3">
                                ...
                                <router-link to="importEleve">

                                    <div class="card" style="background-color: #2C353D;color: white;">

                                        <Icon type="md-walk" style="margin-top: 50px;font-size: 50px;" />
                            ...
                            <div class="col-md-12 col-lg-3">
                                ...
                                <router-link to="importClasse">

                                    <div class="card" style="background-color: #E91E63;color: white;">


                                        <Icon type="md-albums" style="margin-top: 50px;font-size: 50px;" />
