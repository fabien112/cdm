                ...
                <div class="container-full">
                    <section class="content">
                        ...
                        <Alert type="light" closable class="card">
                            ...
                            Ce parent possède {{ InfoEleveParent.length }} enfant(s)
                        ...
                        <div class="row">
                            ...
                            <div v-for="(data, i) in InfoEleveParent" :key="i" class="col-md-12 col-lg-4">
                                        ...
                                        <table class="table simple mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=" font-weight-700">
                                                        {{ data.dateNaiss | dateFormat }} , {{ data.lieuNaiss }}
                                                    </td>
                                                </tr>
