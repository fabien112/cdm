                    ...
                    <section class="content">
                        <div class="box box-default">
                            ...
                            <div class="box-body wizard-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <!-- <input class="form-control required" v-model.trim="
                                                        data.matricule
                                                    " />
                                                    ...
                                                    <input readonly class="form-control required"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select form-control required"
                                                        v-model="data.classe">
                                                        <option v-for="(data,
                                                        i) in classes" :key="i" :value="data.id">
                                                            {{ data.libelleClasse }}
                                            ...
                                            <div class="col-md-6">
                                                <label for="">
                                                    Situation de l'élève dans la classe
                                                </label>

                                                <div class="form-group">
                                                    <RadioGroup v-model="data.redoubl" type="button"
                                                        button-style="solid">
                                                        <Radio label="Nouveau"></Radio>
                                                        <Radio label="Redoublant"></Radio>
                                                    </RadioGroup>
                                                </div>
                                            </div>

                                            <Divider>
                                                LIAISON AVEC SON PARENT
                                            </Divider>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-6">
                                                <Button icon="ios-search" type="primary" @click="modal7 = true"
                                                    size="large">
                                                    Associer un parent
                                                </Button>
                                            </div>
                                        ...
                                        ">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="email" class="form-control required" v-model="
                                                        data.emailParent
                                                    " />
                                                    <span class="text-danger mt-2" v-if="
                                                        (!$v.data
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select readonly class="custom-select form-control required"
                                                        v-model="
                                                            data.sexeParent
                                                        ">
                                                        <option value="">
                                ...
                                <Modal title="Rechercher un parent " v-model="modal7">
                                    <Row>
                                        <Col span="16">
                                        <div class="form-group">
                                            <input type="text" placeholder="Entrer le télephone du parent"
                                                class="form-control required" v-model.trim="data.telSeach" />
                                        </div>
                                        </Col>
                                        <Col span="4" offset="1">
                                        <div class="form-group">
                                            <Button type="primary" icon="ios-search" @click="SearchParent"> Rechercher
                                            </Button>
                                        </div>
                                        </Col>
                                    </Row>
                                    ...
                                    <div class="table-responsive" v-if="parent != ''">
                                        ...
                                        <Button style="background-color:#2D8CF0;color:white" icon="md-repeat"
        ...
        async onSubmit() {
            ...
            if (this.$v.$invalid) {
                ...
                if (res.status == 401) {
                    ...
                    this.s("Elève  ajouté correctement");
        ...
        async SearchParent() {
            if (this.data.telSeach == "") {
                ...
                if (res.data == "") {
                    ...
                    this.data.idParent = this.parent.id;
                }
            }
        },
        ParentForm() {
