                            ...
                            <div class="col-12">
                                <div class="box">
                                    <div class="box-header bg-primary">
                                        <h4 class="box-title" style="margin:auto"> Parents
                                                    ...
                                                    <tr v-for="(data, i) in datas" :key="i">
                                                        ...
                                                        <td style="text-align:center" class="center">
                                                            ...
                                                            <router-link to="enfantsParent">
                                                                <button @click="Details(data, i)" class="btn btn-success btn-xs"
                                                            ...
                                                            <router-link to="updateParent">
                                                                ...
                                                                <button class="btn btn-primary btn-xs" @click="Details(data, i)"
