<template>
                ...
                <div class="container-full">
                    ...
                    <section class="content">
                        ...
                        <Modal v-model="showDelateModal2" width="360">
                            ...
                            <div style="text-align:center">
                                <p> Etes-vous sure de vouloir supprimer ce libellé ?</p>
                            </div>
                            <div slot="footer">
    ...
    ">
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <span class="btn btn-xs"
                                                                                            style="background-color:#18222A;color:white; width:50%;">
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <span v-if="data.affected == 1"
                                                                                            ...
                                                                                            style="background-color:#1f2429;color:white;width: 15%">

                                                                                            <Icon type="md-build" />

                                                                                        </span>

                                                                                        <span v-if="data.affected == 0"
                                                                                            class="btn btn-xs"
                                                                                        ...
                                                                                        <span v-if="data.affected == 0"
                                                                                            ...
                                                                                            " class="btn btn-xs"
                                                                                            style="background-color:#1f2429;color:white;width:25%"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 col-sm-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"
                                                                                class="form-control required" v-model="
                                                                                    data.libelle
                                                                                " />
                                                                        </div>
                                                                    </div>
...
export default {
    ...
    methods: {
        ...
        Details(data, i) {
            ...
            //  this.data2.categorie = data.categorie
